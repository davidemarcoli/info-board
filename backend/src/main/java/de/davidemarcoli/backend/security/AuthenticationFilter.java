...
import de.davidemarcoli.backend.exception.MissingUserCredentialsException;
import de.davidemarcoli.backend.exception.UserNotFoundException;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        de.davidemarcoli.backend.jpa.User userModel = userService.getUserByUsername(user.getUsername());
